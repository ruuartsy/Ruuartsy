  ...
  return (
    <>
      ...
      <Wrapper pageIndex={1} className="max-w-2xl text-center flex flex-col justify-center">
        ...
        <div className="sm:text-[7.2rem] xs:text-7xl text-5xl text-White font-medium">WASITHA SADESHA</div>
        <div className="uppercase font-bold xs:text-2xl text-xl text-Orange text-end mt-8">A Photo <br />Grapher</div>
      </Wrapper>
    </>
  );
}
